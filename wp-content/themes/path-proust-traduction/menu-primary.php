 ...
 if ( has_nav_menu( 'primary' ) ) : ?>
	...
	<nav id="menu-primary-title" class="nav-anchors">
		...
		<div class="wrap">
			...
			<div id="lang-mobile" class="change-language">

			<select id="select-language-mobile" class="select-language" style="top:auto;visibility:inherit;">
	...
	<nav id="menu-primary" class="menu-container">
		...
		<div class="wrap">
			...
			<select id="select-language" class="select-language default">
	                <option value="fr">Français</option>
	                <option value="de">Deutsch</option>
	                <option value="en">English</option>
				</select>
