...
<body class="<?php hybrid_body_class(); ?>">
	...
	<div id="container">
		...
		<?php if ( is_page())  get_sidebar( 'before-content' ); // Loads the sidebar-before-content.php template. ?>

			<div class="wrap">

			<?php do_atomic( 'open_main' ); // path_open_main ?>

<nav itemprop="breadcrumb" class="breadcrumb-trail breadcrumbs"><span class="trail-begin"></span><span class="trail-end"></span></nav>